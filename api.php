...
$productId    = 44879;   // id товара в системе
$productPrice = 599;   // цена товара при создании заказа
$thankUrl     = 'https://piizhama.github.io/first/success/index.html'; // урл вашей страницы спасибо
...
$streamId      = 44879; // id потока в системе (заказ будет привязываться к конретному потоку. полезно при настройке постбека)
